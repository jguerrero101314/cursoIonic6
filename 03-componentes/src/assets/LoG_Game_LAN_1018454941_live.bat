...
:start
@start "" "League of Legends.exe" "spectator spectator.la1.lol.riotgames.com:80 Z3T/g8X7pL6Vl2vtfiAlaBaWegpnmHvY 1018454941 LA1" -UseRads -GameBaseDir=.. "-Locale=%locale%"
goto exit
